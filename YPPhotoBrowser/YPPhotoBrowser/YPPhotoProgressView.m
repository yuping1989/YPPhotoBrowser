...
@interface YPPhotoProgressLayer : CALayer
...
@implementation YPPhotoProgressLayer
...
@interface YPPhotoProgressView () <CAAnimationDelegate>

@end

@implementation YPPhotoProgressView

+ (void) initialize {
    if (self == [YPPhotoProgressView class]) {
        YPPhotoProgressView *circularProgressViewAppearance = [YPPhotoProgressView appearance];
...
+ (Class)layerClass {
    return [YPPhotoProgressLayer class];
}

- (YPPhotoProgressLayer *)circularProgressLayer {
    return (YPPhotoProgressLayer *)self.layer;
}
