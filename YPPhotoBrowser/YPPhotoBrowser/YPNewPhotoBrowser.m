...
#import "YPNewPhotoBrowser.h"
#import "YPPhotoViewCell.h"
#import "YPNewPhotoPageView.h"
#import <objc/runtime.h>

NSString * const YPNewPhotoViewCellIdentifier = @"YPPhotoViewCell";

static const int browser_key;

@interface YPNewPhotoBrowser () <UIActionSheetDelegate> {
...
@implementation YPNewPhotoBrowser
...
- (void)viewDidLoad {
    ...
    // 当转场模式为YPNewPhotoBrowserAnimationTransition时，需等到转场动画完成后，再调用以下代码
    if (self.animationStyle != YPNewPhotoBrowserAnimationTransition) {
        self.photoPageView.pageIndicatorHidden = self.pageIndicatorHidden;
        self.photoPageView.moreButtonHidden = self.moreButtonHidden;
...
- (void)show {
    ...
    } else if (self.animationStyle == YPNewPhotoBrowserAnimationFade) {
...
#pragma mark - YPNewPhotoPageViewDataSource
...
#pragma mark - YPNewPhotoPageViewDelegate
